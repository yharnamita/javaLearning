...
//COM A SOMA E MEDIA DOS ELEMENTOS DO VETOR
...
public class Exercicio14 {
    ...
    public static void main(String[] args) {
        ...
        int n = Utility.lerIntervaloInt(sc, "Quantos numeros voce vai digitar? ", 1, Integer.MAX_VALUE);
        ...
        for (int i = 0; i < n; i++) {
            ...
            vetor[i] = Utility.lerDoubleSeguro(sc, "Digite um numero: ");
            soma += vetor[i];
        }
